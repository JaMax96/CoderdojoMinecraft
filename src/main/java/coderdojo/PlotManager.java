...
public class PlotManager {
    ...
    public PlotManager(DataService dataService) {
        this.regionGenerator = new RegionGenerator(-110, -450, 110, 450, "plotGenerator", dataService);
    }
    ...
    private void teleportPlayerToPlot(Player player, ProtectedRegion region) {
        ...
        while (y > 0 && world.getBlockAt(middle.getX(), y - 1, middle.getBlockZ()).getType().equals(Material.AIR)) {
            y--;
        }
